...
export default multiConnect(alertStore.selectors,
  alertStore.actionCreators, 'ReduxStoreMultiStoreClient')(AlertWithLifeCycle);

export const makeWrappedActionCreators = id => wrapActionCreators(alertStore.actionCreators, id);
